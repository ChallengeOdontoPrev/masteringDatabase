...
CREATE OR REPLACE PACKAGE clinic_pkg AS
    ...
    FUNCTION valida_email(p_email IN VARCHAR2) RETURN BOOLEAN;
    FUNCTION valida_telefone(p_telefone IN VARCHAR2) RETURN BOOLEAN;

    PROCEDURE INSERT_CLINIC(
        CNPJ IN VARCHAR2, 
        EMAIL IN VARCHAR2,
        NAME IN VARCHAR2,
        PHONE IN VARCHAR2,
    ...
    PROCEDURE READ_CLINIC(p_id IN NUMBER);

    PROCEDURE UPDATE_CLINIC(
        p_id IN NUMBER,
        p_cnpj IN VARCHAR2, 
        p_email IN VARCHAR2,
        p_name IN VARCHAR2,
    ...
    PROCEDURE DELETE_CLINIC(p_id IN NUMBER);
END clinic_pkg;
...
CREATE OR REPLACE PACKAGE BODY clinic_pkg AS
    ...
    FUNCTION valida_email(p_email IN VARCHAR2) RETURN BOOLEAN IS
    BEGIN
    ...
    FUNCTION valida_telefone(p_telefone IN VARCHAR2) RETURN BOOLEAN IS
    BEGIN
    ...
    PROCEDURE READ_CLINIC(p_id IN NUMBER) IS
    ...
    PROCEDURE DELETE_CLINIC(p_id IN NUMBER) IS
        v_count NUMBER;
    BEGIN
        SELECT COUNT(*)
        INTO v_count
