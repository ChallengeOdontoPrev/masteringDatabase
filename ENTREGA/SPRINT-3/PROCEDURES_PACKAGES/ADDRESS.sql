...
CREATE OR REPLACE PACKAGE address_pkg AS
    FUNCTION valida_cep(p_cep IN VARCHAR2) RETURN BOOLEAN;
    FUNCTION valida_sigla_estado(p_sigla IN VARCHAR2) RETURN BOOLEAN;
    ...
    PROCEDURE READ_ADDRESS(p_id IN NUMBER);
    ...
    PROCEDURE DELETE_ADDRESS(p_id IN NUMBER);
END address_pkg;

CREATE OR REPLACE PACKAGE BODY address_pkg AS
    FUNCTION valida_cep(p_cep IN VARCHAR2) RETURN BOOLEAN IS
    BEGIN
    ...
    FUNCTION valida_sigla_estado(p_sigla IN VARCHAR2) RETURN BOOLEAN IS
    BEGIN
    ...
    PROCEDURE READ_ADDRESS(p_id IN NUMBER) IS
    ...
    PROCEDURE DELETE_ADDRESS(p_id IN NUMBER) IS
    BEGIN
